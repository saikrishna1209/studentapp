          ...
          <div className="grid h-screen place-items-center">
              <div className="sm:mx-auto sm:w-full sm:max-w-md rounded-lg w-1/4 p-10  relative bg-white ">
                  ...
                  <div className="flex gap-24 mt-3   ">
                      ...
                      <div className="text-sm mt-1 text-cyan-600 hover:text-orange-500">
                  ...
                  <div className="mt-2">
                      <button
                          type="submit"
                          className=" bg-cyan-500 text-white  rounded  hover:bg-cyan-600-700 hover:shadow-lg focus:bg-orange-700  ease-in-out w-full py-2 mt-2"
                      >
                          <Link href="/details">Log in </Link>
                      </button>
                  </div>
              </div>
          </div></>
