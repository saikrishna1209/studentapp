            ...
            <div class="grid grid-cols-2 gap-8 p-14 bg-slate-400">
              <div class=" ">
                <div className="bg-slate-300 border-solid border-2 border-black">
                  ...
                  <Link href={"https://www.sanfoundry.com/best-reference-books-btech-1st-year/"}>Basic Electronics Engineering Books</Link>
                  </h1>
                </div>
              </div>
              <div class=" border-solid border-2 border-black bg-slate-300">
                <h1 className="text-2xl font-bold  m-0.5 p-20">
                <Link href={"https://www.sanfoundry.com/best-reference-books-btech-1st-year/"}>Advance Engineering Mathematics Books</Link>
                </h1>
              </div>
              <div class="  border-solid border-2 border-black bg-slate-300">
                <h1 className="text-2xl font-bold  m-0.5 p-20">
              <Link href={"https://www.sanfoundry.com/best-reference-books-btech-1st-year/"}>Professional Communication Books</Link>
                </h1>
              </div>
            </div>
